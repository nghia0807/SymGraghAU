...
def train(conf, net, train_loader, optimizer, epoch, criterion):
    ...
    for batch_idx, (inputs,  targets, relations) in enumerate(tqdm(train_loader)):
        ...
        # print("---------")
        # print(outputs_relation.size() )
        # print(outputs_relation.view(-1,4).size(), outputs_relation.view(-1,4) )
        # print(relations.size() )
        # print(relations.view(-1).size() ,relations.view(-1) )
        # print(relations.view(-1))
