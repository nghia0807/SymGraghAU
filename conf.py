...
parser.add_argument('--lam', default=0.05, type=float, help="lambda for adjusting loss")
...
parser.add_argument('--resume-phase2', default='', type=str, metavar='path', help='path to latest checkpoint of Phase 2 (default: none)')
